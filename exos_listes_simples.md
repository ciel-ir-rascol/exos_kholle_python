...
**Sommaire**
- [1. Liste d’entiers consécutifs décroissants et alternant de signe](#1-liste-dentiers-consécutifs-décroissants-et-alternant-de-signe)
- [2. Liste : négatif -\> opposé](#2-liste--négatif---opposé)
- [3. Liste des carrés entre deux nombres](#3-liste-des-carrés-entre-deux-nombres)
- [4. Liste des entiers impairs suivi des pairs](#4-liste-des-entiers-impairs-suivi-des-pairs)
- [5. Séparer en indices pairs et indices impairs](#5-séparer-en-indices-pairs-et-indices-impairs)
- [6. Un, deux ou cinq](#6-un-deux-ou-cinq)
- [7. Rotation de liste](#7-rotation-de-liste)
- [8. Affichage en tas binaire (une seule boucle for)](#8-affichage-en-tas-binaire-une-seule-boucle-for)
- [9. Afficher toutes les dates de l’année](#9-afficher-toutes-les-dates-de-lannée)
- [10. Inverser indices et valeurs dans une liste](#10-inverser-indices-et-valeurs-dans-une-liste)

## 1. Liste d’entiers consécutifs décroissants et alternant de signe
...
## 4. Liste des entiers impairs suivi des pairs
...
## 8. Affichage en tas binaire (une seule boucle for)
...
## 9. Afficher toutes les dates de l’année
...
## 10. Inverser indices et valeurs dans une liste
